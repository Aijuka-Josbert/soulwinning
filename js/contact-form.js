  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      ...
      if (result.success) {
        ...
        statusEl.textContent = 'Something went wrong sending your message. Please try again or call us directly.';
        statusEl.classList.add('form-status--error');
      }
    } catch (err) {
      statusEl.textContent = 'Could not send your message — please check your connection or call us directly.';
      statusEl.classList.add('form-status--error');
    } finally {
